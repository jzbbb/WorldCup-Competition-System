            ...
            <div style="padding: 80px; padding-top:40px;" class="view">
                ...
                <div class="container">
                    <div class="border border-success" style="display: inline-block; width: 850px; height: 450px; background-color:aliceblue;">
                        ...
                        $sqlb = "select comment from game where game_id={$xgid}";
                        $resb = mysqli_query($dbc, $sqlb);
                        if ($resb == 1) {
                            $resultb = mysqli_fetch_array($resb);
                            echo "</strong><br><h4 style='padding: 10px;'>{$resultb['comment']}</h4>";
                        } else {
                ...
                <center><button type="button" class="layui-btn layui-btn-danger" style="margin: 10px;"><a href="admin_groupgame.php" style="color:white">返回</a></button></center>
            </div>
        </div>
