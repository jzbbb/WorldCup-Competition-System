    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="layui-nav-item layui-hide-xs"><a href="">球员查看</a></li>
            </ul>
            ...
            <div style="padding: 80px; padding-top:40px;" class="view">
                ...
                <div class="container">
                    <div class="border border-success" style="display: inline-block; width: 850px; height: 450px; background-color:aliceblue;">
                        ...
                        $sqlb = "select player_name,player_desc from player where player_id={$xgid}";
                        $resb = mysqli_query($dbc, $sqlb);
                        if ($resb == 1) {
                            $resultb = mysqli_fetch_array($resb);
                            echo '<h1 class="text-center"><strong>';
                            echo "{$resultb['player_name']}";
                            echo "</strong></h1><br><h4 style='padding: 10px;'>{$resultb['player_desc']}</h4>";
                        } else {
                ...
                <center><button type="button" class="layui-btn layui-btn-danger" style="margin: 10px;"><a href="admin_player.php" style="color:white">返回</a></button></center>
            </div>
        </div>
