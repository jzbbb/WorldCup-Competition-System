    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="layui-nav-item layui-hide-xs"><a href="">添加比赛</a></li>
            </ul>
        ...
        <div class="layui-body">
            <div style="padding: 50px 200px 50px;">
                <center>
                    <form id="query" action="admin_game_add.php?userid=<?php echo $user_id; ?>" method="POST">
                        <div id="query">
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        <div class="input-group "><span class="input-group-addon">主队名</span><input style="width:200px; margin-right:10px" required="required" pattern="^[0-9]{1,2}$" name="t1" type="text" placeholder="主队编号" class="form-control"></div>
                                    </div>
                                </div>
                                <br />
                                <br />
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        <div class="input-group"><span class="input-group-addon">客队名</span><input style="width:200px;" required="required" pattern="^[0-9]{1,2}$" name="t2" type="text" placeholder="客队编号" class="form-control"></div>
                                    </div>
                                </div>
                                <br />
                                <br />
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        <div class="input-group"><span class="input-group-addon">比赛类型</span><input style="width:200px;" required="required" pattern="^[0-9]{1,2}$" name="gtype" type="text" placeholder="(1:小组赛,2:淘汰赛)" class="form-control"></div>
                                    </div>
                                </div>
                            </div>
                            <br />
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        <div class="input-group"><span class="input-group-addon">开始时间</span><input style="width:200px;" name="time" type="text" placeholder="输入比赛开始时间" class="form-control"></div>
                                    </div>
                                </div>
                                <br>
                            </div>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $gtype = $_POST["gtype"];
            $time = $_POST["time"];
            $sqla = "insert into game(home_team_id,guest_team_id,game_type,begin_time,createBy) values($t1,$t2,$gtype,'{$time}',$userid);";
